...
export async function checkearEstadoEnvio(dbConnection, shipmentId, companyId) {
    ...
    if (estado.length > 0) {
        if (estado[0].estado_envio == 5 || estado[0].estado_envio == 9 || (companyId != 137 && estado[0].estado_envio == 8)) {
